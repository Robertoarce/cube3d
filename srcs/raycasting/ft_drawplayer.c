...
/*   Updated: 2020/11/07 11:26:40 by titorium         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_drawtail(t_data data, t_pixel *img, int color, int paso)
{
	...
	{
		ptr->x0 = data.player.cube.x0 + ((data.player.cube.x1 - data.player.cube.x0) / 2);
		ptr->y0 = data.player.cube.y0 + ((data.player.cube.y1 - data.player.cube.y0) / 2);
